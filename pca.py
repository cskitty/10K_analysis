...
infile = open('/Users/Xuan/melody/case1/item1/AAPL/0000320193-17-000070.txt')

item1Text = infile.read()

infile.close()

item1Text = item1Text.lower().replace('\n', " ")

print(item1Text)

for regWord in wordRegExpressions:
    print(regWord, len(re.findall(regWord, item1Text)))